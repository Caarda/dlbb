...
# You really only need to run this when someone wants their displayed username updated or if speedrun.com decides to change platform IDs for some reason.
